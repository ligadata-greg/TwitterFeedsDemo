...
//				System.out.println(row);
	...
	public List<GenericObj> selectAllByAlertTime(InfluxDB connection, String alertTime, String timeWindow) {
		// TODO Auto-generated method stub
		AlertsObj alObj = null;
		List<GenericObj> result = new ArrayList<GenericObj>();
		List<Serie> series = connection.query("demo",
				"SELECT * from alerts where time < "+alertTime+" and time > " + alertTime + " - " + timeWindow + " limit 20", TimeUnit.MILLISECONDS);
